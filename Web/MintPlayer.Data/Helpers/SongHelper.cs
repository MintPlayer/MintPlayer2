...
namespace MintPlayer.Data.Helpers
{
	...
	{
		internal void CalculateUpdatedArtists(Song old, Dtos.Song @new, MintPlayerContext dbContext, out IEnumerable<ArtistSong> to_add, out IEnumerable<ArtistSong> to_update, out IEnumerable<ArtistSong> to_remove)
		{
